        ...
        <Bounds fit clip observe>
          ...
          <ScrollControls pages={3}>
            ...
            <Scroll html>
              ...
              <video style={{ position: 'absolute', top: '370vh', left: '50vw', width: '90vw',  height: 'auto'  }}  controls>
                <source src="cybertruck.mp4" type="video/mp4" />
                Your browser does not support the video tag.
              </video>

              <button className="order-btn" style={{ position: 'absolute', top: '400vh', left: '50vw' }} onClick={() => navigate('/')}>ORDER NOW </button>
